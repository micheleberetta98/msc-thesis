...
and it can be interpreted, but it is usually \textit{just-in-time compiled}.
...
Since web browsers run JavaScript files received via the Web, there is the potential for authors to deliver
malicious scripts. Browsers mitigate these risks using both a \textit{sandbox}, disallowing JS to perform general-purpose
...
such as \textit{asm.js}, and eventually \textit{WebAssembly}.
