...
Sometimes hardware vulnerabilities have also been found - in 2019, the Spectre paper included a JavaScript implementation
...
and all this boundary crossings are explicit. The isolation is enforced by sandboxing mechansims, such as
