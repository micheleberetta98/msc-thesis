...
This way, a traditional C program can handle directly the functions made available from the original C library with an added sandbox
...
Unlike Landlock, eBPF makes it possible to define specific exceptions, e.g., denying
