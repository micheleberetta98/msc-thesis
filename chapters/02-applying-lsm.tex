...
This however must be esplicitely declared in the policy, since all policies are tainted, hence enforced, by default.
...
when \textit{bash} tries to write or append anywhere in the filesystem.
